...
function(cdoom_rust_link target)
    ...
    if(USE_RUST_M_MISC)
        target_compile_definitions("${target}" PRIVATE USE_RUST_M_MISC=1)
    endif()
    if(USE_RUST_M_CONFIG)
        target_compile_definitions("${target}" PRIVATE USE_RUST_M_CONFIG=1)
    endif()
    if(USE_RUST_M_CONTROLS)
        target_compile_definitions("${target}" PRIVATE USE_RUST_M_CONTROLS=1)
    endif()
endfunction()
