...
option(USE_RUST_M_ARGV "Route m_argv through cdoom-core Rust ABI" OFF)
option(USE_RUST_M_CHEAT "Route m_cheat through cdoom-core Rust ABI" OFF)
...
function(cdoom_rust_link target)
    ...
    if(USE_RUST_M_ARGV)
        target_compile_definitions("${target}" PRIVATE USE_RUST_M_ARGV=1)
    endif()
    if(USE_RUST_M_CHEAT)
        target_compile_definitions("${target}" PRIVATE USE_RUST_M_CHEAT=1)
    endif()
endfunction()
