...
option(USE_RUST_DEH_MAIN "Route shared Dehacked parser core through Rust" ON)
...
function(cdoom_rust_link target)
    ...
    if(USE_RUST_DEH_MAIN)
        target_compile_definitions("${target}" PRIVATE USE_RUST_DEH_MAIN=1)
    endif()
endfunction()
