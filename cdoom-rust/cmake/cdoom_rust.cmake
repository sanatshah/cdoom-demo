...
option(USE_RUST_P_REJECTPAD "Route p_rejectpad through cdoom-core Rust implementation" ON)
...
function(cdoom_rust_link target)
    ...
    if(USE_RUST_P_REJECTPAD)
        target_compile_definitions("${target}" PRIVATE USE_RUST_P_REJECTPAD=1)
    endif()
endfunction()
