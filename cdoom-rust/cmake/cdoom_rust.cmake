...
function(cdoom_rust_link target)
    ...
    if(USE_RUST_MEMIO)
        target_compile_definitions("${target}" PRIVATE USE_RUST_MEMIO=1)
    endif()
    if(USE_RUST_SHA1)
        target_compile_definitions("${target}" PRIVATE USE_RUST_SHA1=1)
    endif()
    if(USE_RUST_AES_PRNG)
        target_compile_definitions("${target}" PRIVATE USE_RUST_AES_PRNG=1)
    endif()
endfunction()
