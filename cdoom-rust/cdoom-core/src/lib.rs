...
pub use ffi::{
    ...
    cdoom_rust_v_draw_xla_patch, cdoom_rust_v_gamma_correct_palette, cdoom_rust_v_mark_rect,
    cdoom_rust_v_register_buffers, cdoom_rust_v_restore_buffer, cdoom_rust_v_set_tint_table,
    cdoom_rust_v_set_xla_table, cdoom_rust_v_use_buffer, cdoom_rust_version,
};
