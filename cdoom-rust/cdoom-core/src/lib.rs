...
pub use ffi::{
    cdoom_rust_angle_to_fine_index, cdoom_rust_fixed_div, cdoom_rust_fixed_mul, cdoom_rust_init,
    cdoom_rust_m_add_to_box, cdoom_rust_m_clear_box, cdoom_rust_version,
};
