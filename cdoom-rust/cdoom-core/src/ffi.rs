...
use crate::v_video;
use crate::v_video::patch::PatchPtr;
use std::ffi::CString;
...
#[no_mangle]
pub extern "C" fn cdoom_rust_v_gamma_correct_palette(
    dest_rgb: *mut u8,
    source_rgb: *const u8,
    ...
    v_video::gamma_correct_palette(dest_rgb, source_rgb, gamma_table, gamma_level, color_count);
}
