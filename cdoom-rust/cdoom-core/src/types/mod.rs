//! C-compatible foundational types and constants used by early migrations.
//!
//! These mirror Chocolate Doom headers closely so migrated modules can preserve
//! integer widths, truthiness, and key code values at the FFI boundary.
...
pub fn doom_short(value: u16) -> i16 {
    i16::from_le_bytes(value.to_le_bytes())
}

pub fn doom_long(value: u32) -> i32 {
