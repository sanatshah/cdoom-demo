...
const SIMPLE_MUS: &[u8] = &[
    b'M', b'U', b'S', 0x1A, 0x07, 0x00, 0x0E, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x90, 0xBC,
    0x64, 0x0A, 0x80, 0x3C, 0x05, 0x60,
];

const SIMPLE_MIDI: &[u8] = &[
    b'M', b'T', b'h', b'd', 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x01, 0x00, 0x46, b'M', b'T',
    b'r', b'k', 0x00, 0x00, 0x00, 0x10, 0x00, 0xB0, 0x7B, 0x00, 0x00, 0x90, 0x3C, 0x64, 0x0A, 0x80,
    0x3C, 0x00, 0x05, 0xFF, 0x2F, 0x00,
];
